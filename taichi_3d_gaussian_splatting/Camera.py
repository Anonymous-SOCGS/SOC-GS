...
class CameraInfo:
    ...
    camera_intrinsics_multispectral: torch.Tensor  # 3x3 matrix for MS
    camera_height_multispectral: int  # height of the MS image
    camera_width_multispectral: int  # width of the MS image
    camera_intrinsics_infrared: torch.Tensor  # 3x3 matrix for IR
    camera_height_infrared: int  # height of the IR image
    camera_width_infrared: int  # width of the IR image
